...
def vectorSingle(filename,word2idx,vocab):
...
def mtcnnPredict(filename,word2idx,vocab,siteIdtoLabel,histologyIdtoLabel):
    vec = vectorSingle(filename, word2idx, vocab)
...
if __name__ == '__main__':
    ...
    filename="TCGA-2A-AAYO.3889AA76-F350-4DA4-987B-79E8D2349262.txt"
    ...
    mtcnnPredict(filename,word2idx,vocab,siteIdtoLabel,histologyIdtoLabel)
